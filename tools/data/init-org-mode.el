...
;; see http://doc.norang.ca/org-mode.html for details

;; Associate sounds to org-mode actions
;;(defun play-sound-on-task-state-change ()
;;  "Play a sound when task's state is set to DONE."
;; (when (string-equal org-state "DONE")
;;    (play-sound-file "~/sounds/tos-computer-06.wav"))
;;  (when (string-equal org-state "CANCELLED")
;;    (play-sound-file "~/sounds/tos-computer-01.wav"))
;;  (when (string-equal org-state "HOLD")
;;    (play-sound-file "~/sounds/tos-computer-05.wav"))
;;  (when (string-equal org-state "NEXT")
;;    (play-sound-file "~/sounds/activate.wav"))
;;  (when (string-equal org-state "WAITING")
;;    (play-sound-file "~/sounds/tos-computer-03.wav")))
...
(global-set-key (kbd "C-c C-l") 'org-toggle-link-display)
